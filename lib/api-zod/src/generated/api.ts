...
export const GetCustomerLedgerResponse = zod.object({
  ...
  "totalDiscountAmount": zod.number().optional(),
...
export const ListSaleOrdersResponseItem = zod.object({
  ...
  "discountAmount": zod.number().describe('Flat discount agreed at sale time. Never exceeds totalAmount.'),
  "netAmount": zod.number().describe('totalAmount - discountAmount — what the customer actually owes for this order.'),
...
export const CreateSaleOrderBody = zod.object({
  ...
  "discountAmount": zod.number().optional().describe('Flat discount off the order total. Must not exceed the sum of item amounts.'),
  "items": zod.array(zod.object({
  "productId": zod.number(),
  "qty": zod.number(),
...
export const CreateSaleOrderResponse = zod.object({
  "id": zod.number(),
  "customerId": zod.number(),
  "customerName": zod.string(),
  "date": zod.coerce.date(),
...
export const ListSupplierPaymentsResponseItem = zod.object({
  ...
  "amount": zod.number(),
  "discountAmount": zod.number().optional().describe('Settlement discount agreed with the supplier at payment time (e.g. owe 20,500, pay 20,000 cash, supplier writes off 500). Reduces payable the same as amount, but never posts to cashbook. amount + discountAmount must not exceed the supplier\'s payable balance at the time of payment.\n'),
  "discountReason": zod.string().nullish().describe('Required whenever discountAmount > 0 — a dedicated audit trail for why the discount was given.'),
  "bankAccount": zod.string().nullish(),
  "chequeNo": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "createdAt": zod.coerce.date(),
...
export const CreateInstallmentPlanResponse = zod.object({
  "id": zod.number(),
  "customerId": zod.number(),
  "customerName": zod.string(),
  "saleOrderId": zod.number().nullish(),
...
export const DeleteInstallmentPlanResponse = zod.void()
 ...
 */
export const CorrectInstallmentPaymentParams = zod.object({
  "paymentId": zod.coerce.number()
})

export const CorrectInstallmentPaymentBody = zod.object({
  "void": zod.boolean().optional(),
  "reason": zod.string().optional(),
  "scheduleId": zod.number().nullish(),
  "date": zod.coerce.date().optional(),
  ...
  "paymentMode": zod.enum(['cash', 'bank_transfer', 'cheque', 'online']).optional(),
  "notes": zod.string().optional()
}).describe('Either set void=true to reverse the original with no replacement, or omit it and supply the corrected data (same shape as InstallmentPaymentInput) to reverse-and-replace.\n')

export const CorrectInstallmentPaymentResponse = zod.object({
  "id": zod.number(),
  "customerId": zod.number(),
  "customerName": zod.string(),
  "saleOrderId": zod.number().nullish(),
...
export const DeleteStockAdjustmentResponse = zod.void()
...
export const GetSupplierLedgerResponse = zod.object({
  ...
  "totalPaid": zod.number(),
  "totalDiscountAmount": zod.number(),
  "totalReturnValue": zod.number(),
  "totalRefundAmount": zod.number(),
  "from": zod.coerce.date().nullable(),
  "to": zod.coerce.date().nullable(),
...
export const CreateCashbookEntryResponse = zod.object({
  "id": zod.number(),
  "date": zod.coerce.date(),
  "type": zod.enum(['cash_in', 'cash_out']),
  "source": zod.enum(['manual', 'payment', 'expense', 'purchase', 'opening_balance', 'adjustment', 'salary', 'transfer']),
 ...
 */
export const CorrectExpenseParams = zod.object({
  "id": zod.coerce.number()
})

export const CorrectExpenseBody = zod.object({
  "void": zod.boolean().optional(),
  "reason": zod.string().optional(),
  "date": zod.coerce.date().optional(),
  ...
  "paymentMode": zod.enum(['cash', 'bank', 'easypaisa', 'jazzcash', 'cheque', 'other']).optional(),
  "notes": zod.string().optional()
}).describe('Either set void=true to reverse the original with no replacement, or omit it and supply the corrected data (same shape as ExpenseInput) to reverse-and-replace.\n')

export const CorrectExpenseResponse = zod.object({
  "original": zod.object({
  "id": zod.number(),
  "date": zod.coerce.date(),
  "category": zod.string(),
